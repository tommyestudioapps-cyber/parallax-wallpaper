    ...
    <View style={[styles.screen, { backgroundColor: colors.background, paddingTop: insets.top }]}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.tipCard, { backgroundColor: colors.secondary, borderColor: colors.border }]}>
          ...
          <Text style={[styles.bodyTextSmall, { color: colors.mutedForeground, textAlign: 'center' }]}>Dica: use fotos com elementos em distâncias diferentes para um efeito mais cinematográfico.</Text>
        </View>
